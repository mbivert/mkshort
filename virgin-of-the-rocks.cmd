ffmpeg -y \
	-r 30 -t 35.80 -loop 1 -i "virgin-of-the-rocks-paris.jpg" \
	...
	-r 1 -t 5.00 -loop 1 -i "/home/mb/gits/mkshort/.cache/b954eb86f84bbd64ddb38f90c98b7f7a3afb7829daa81f957b2737b447fc9ec0.png" \
	...
	-filter_complex "
		...
		[in0,5] [6:v] overlay=x=(W-w)/2:y=(H-h)/2:enable='between(t,19.70,23.70)' [in0,6];
		[in0,6] [7:v] overlay=x=(W-w)/2:y=(H-h)/2:enable='between(t,24.40,27.40)' [in0,7];
		[in0,7] [8:v] overlay=x=(W-w)/2:y=(H-h)/2:enable='between(t,30.80,34.80)' [in0,9];
